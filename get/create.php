...
<html>
  <head>
    ...
    <script src='//URL.jonathan2018.repl.co/script.js'></script>
    <link href='//URL.jonathan2018.repl.co/style.css' rel='stylesheet' type='text/css' />
    <link href='//URL.jonathan2018.repl.co/redirect.css' rel='stylesheet' type='text/css' />
...
while(file_exists("g/$file.html")){
  $file = rand(100,1000000);
}



  $urlfile = fopen("g/$file.html", "w") or die("Unable to open file!");
...
<a id="link" target="_blank" href="https://URL.jonathan2018.repl.co/get/g/<?=$file?>.html">https://URL.jonathan2018.repl.co/get/g/<?=$file?>.html</a>

<img class="copy" id="lightcopy" src="//url.jonathan2018.repl.co/images/copylight.png" onclick="Copy('#link');" alt="Copy" title="Copy Link">
